...
<head>
    ...
    <title>Recuperar Contraseña - Colegio Médico</title>
            ...
            <div class="col-12 col-md-7 col-lg-4">
                ...
                <div class="card card-login border-0">
                    ...
                    <div class="card-header bg-success text-white text-center py-4 rounded-top-4">
                        ...
                        <p class="small text-white-50 mb-0">Recuperación de Contraseña</p>
                    </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="text-center mt-4">
                                <a class="text-decoration-none small text-muted fw-semibold" href="{{ route('login') }}">
