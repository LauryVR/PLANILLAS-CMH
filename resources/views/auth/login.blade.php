...
<head>
    ...
    <title>Iniciar Sesión - Colegio Médico</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-7 col-lg-4">
                ...
                <!-- Card flotante con sombra pronunciada -->
                <div class="card card-login border-0">
                    ...
                    <div class="card-header bg-success text-white text-center py-4 rounded-top-4">
                        ...
                        <p class="small text-white-50 mb-0">Sistema de Planillas</p>
                    </div>
                ...
                <!-- Footer en Blanco para legibilidad sobre el fondo verde -->
